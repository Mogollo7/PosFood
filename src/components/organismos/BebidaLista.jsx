...
export default function EntradaBebidas() {
    ...
    // Productos cargados desde la base de datos (categoria_id = 2)
  ...
  return (
    <Container>
      ...
      <ImgContainer>
        <img src="https://sgyzflydqslwjersmisz.supabase.co/storage/v1/object/public/productos/ImgLarge/Bebidas.webp" />
      </ImgContainer>
